...
async def LoginView(page:ft.Page, params:Params, basket:Basket):
    ...
    async def goto_MainView(e):
        ...
        if nombre is None or nombre == "":
            page.open(
                await alerta(
                    titulo= page.trad["error_name_dialg_title"][page.lenguage],
                    descripcion= page.trad["error_name_dialg_description"][page.lenguage]
                    )
                )
            return
        
        basket.nombre = nombre
        page.username = nombre
        await page.client_storage.set_async("username", nombre)
        page.go("/")
    ...
    async def save_photo_perfil(e:ft.FilePickerResultEvent):
        if e.files is None:
            return 0
        await page.client_storage.set_async("photo_perfil", e.files[0].path)
    ...
    async def enable_premium(e):
        ...
        await page.client_storage.set_async("premium_mode", page.premium_mode)
    ...
    name_user = ft.TextField(
        label=page.trad["name_user"][page.lenguage],
        width=page.ancho*0.30,
        border=ft.InputBorder.UNDERLINE,
        filled=True,
        hint_text=page.trad["name_user_hint"][page.lenguage],
    ...
    pass_user = ft.TextField(
        ...
        label=page.trad["pass_user"][page.lenguage],
        width=page.ancho*0.30,
        border=ft.InputBorder.UNDERLINE,
        filled=True,
        hint_text=page.trad["pass_user_hint"][page.lenguage],
        fill_color=ft.Colors.WHITE10,
        border_radius=3,
        focused_border_color=ft.Colors.WHITE,
        label_style=ft.TextStyle(color=ft.Colors.WHITE),
        visible=page.premium_mode,
    )
                    ...
                    ft.Column(
                        controls=[
                            ft.Container(
                                ...
                                tooltip=page.trad["Resolution_perfil"][page.lenguage],
                            ...
                            ft.OutlinedButton(
                                ...
                                content=ft.Text(value=page.trad["button_login"][page.lenguage], text_align=ft.TextAlign.CENTER, font_family="Katana", size=page.ancho/45),
